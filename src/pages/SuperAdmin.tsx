          ...
          <div className="grid gap-6 lg:grid-cols-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Paramètres par défaut des notifications pour tous les utilisateurs</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="flex items-center justify-between gap-4 rounded-lg border p-4">
                  <div>
                    <Label className="text-sm font-medium">Notifications email</Label>
                    <p className="text-xs text-muted-foreground mt-0.5">Activer l'envoi d'emails de notification aux utilisateurs</p>
                  </div>
                  <Switch
                ...
                <div className="flex items-center justify-between gap-4 rounded-lg border p-4">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-0.5">
                      Nombre de jours avant l'échéance pour envoyer un rappel automatique
                    </p>
                  </div>
                  <Input
                    type="number"
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  {[
                    { color: "bg-blue-500", label: "Assignation", desc: "Quand un responsable est assigné à une action, un risque ou une tâche" },
                    { color: "bg-amber-500", label: "Échéance proche", desc: "Rappel automatique N jours avant la date limite" },
                    { color: "bg-destructive", label: "Retard", desc: "Quand une action dépasse sa date d'échéance" },
                    { color: "bg-emerald-500", label: "Changement de statut", desc: "Quand le statut d'un élément est modifié" },
                  ].map((t) => (
                ...
                <p className="text-xs text-muted-foreground mt-4">
                  Chaque utilisateur peut personnaliser ses préférences de réception (push, email, les deux ou aucun) depuis l'icône cloche du header.
                </p>
              </CardContent>
            </Card>
          </div>
