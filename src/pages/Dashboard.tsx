...
export default function Dashboard() {
  ...
  const cards: { label: string; value: number; icon: any; desc: string; color: string; helpTerm: string }[] = [
    { label: "Processus", value: stats.totalProcesses, icon: Network, desc: `M:${stats.processesByType.pilotage} R:${stats.processesByType.realisation} S:${stats.processesByType.support}`, color: "text-primary", helpTerm: "processus" },
    { label: "Audits en cours", value: stats.openAudits, icon: ClipboardCheck, desc: "Planifiés ou en cours", color: "text-accent", helpTerm: "audit" },
    { label: "NC ouvertes", value: stats.openNC, icon: XCircle, desc: "Non-conformités ouvertes", color: "text-destructive", helpTerm: "non_conformite" },
    { label: "Actions en retard", value: stats.overdueActions, icon: Zap, desc: "Échéance dépassée", color: "text-warning", helpTerm: "action_amelioration" },
    { label: "Risques identifiés", value: stats.totalRisks, icon: AlertTriangle, desc: "Risques & opportunités", color: "text-orange-500", helpTerm: "risques_opportunites" },
    { label: "Indicateurs", value: stats.totalIndicators, icon: BarChart3, desc: "Indicateurs définis", color: "text-primary", helpTerm: "indicateur" },
    { label: "Incidents ouverts", value: stats.incidentsOuverts, icon: AlertOctagon, desc: `dont ${stats.incidentsCritiques} critique(s)`, color: "text-orange-600", helpTerm: "risques_opportunites" },
  ];
